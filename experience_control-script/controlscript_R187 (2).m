...
expt.probe_highlow_first = 1;
expt.start_trial = 'Highlow';
expt.probe_start = 'Highlow';
expt.pedestal_location = 'SW';
expt.good_lfp = '12a';
...
fprintf(state.log, 'Start trial: %s \nProbe start: %s \nPedestal location: %s \nGood LFP: %s\n\n', expt.start_trial, expt.probe_start, expt.pedestal_location, expt.good_lfp);
